...
public class IkasleenTaulaController implements Initializable {
    ...
    @FXML
    private void handlebtn_gordeAction(ActionEvent event) throws TransformerException, TransformerConfigurationException, ParserConfigurationException {
        ...
        if (filePath.endsWith(".csv") || filePath.endsWith(".txt")) {
            ...
            XMLFitxategia.datuakFitxategianGorde(tableviua.getItems(), filePath);
