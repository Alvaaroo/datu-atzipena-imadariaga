    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        try {
            ...
            for (int i = 0; i < ar.size(); i++) {
                ...
                izena.appendChild(document.createTextNode(ar.get(i).asJsonObject().getJsonString("Mendia") + ""));
                Mendia.appendChild(izena);

                Element altuera = document.createElement("altuera");
                altuera.appendChild(document.createTextNode(ar.get(i).asJsonObject().getJsonNumber("Altuera") + ""));
                Mendia.appendChild(altuera);

                Element probintzia = document.createElement("probintzia");
                probintzia.appendChild(document.createTextNode(ar.get(i).asJsonObject().getJsonString("Probintzia") + ""));
